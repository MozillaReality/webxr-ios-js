...
/*
PortalDevice takes over a handset's full screen and presents a moving view into a Reality, as if it were a magic window.
...
*/
export default class PortalDevice extends XRDevice {
	...
	PortalDevice just adds the layer's canvas to DOM elements created by the XR polyfill
	*/
	...
	*/
	...
	_updateFromVRDevice(){
		...
		// TODO this._devicePosition.add(0, XRViewPose.SITTING_EYE_HEIGHT, 0)
	...
	_handleARKitUpdate(...params){
		...
		if (cameraTransformMatrix) {
			...
			// TODO this._headPose._poseModelMatrix[13] += XRViewPose.SITTING_EYE_HEIGHT
	...
	//attribute EventHandler ondeactivate; // PortalDevice never deactivates
}